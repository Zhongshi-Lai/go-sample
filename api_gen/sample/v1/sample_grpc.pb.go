...
const (
	SampleService_Echo_FullMethodName = "/proto.sample.v1.SampleService/Echo"
)
...
func (c *sampleServiceClient) Echo(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*StringMessage, error) {
...
func (UnimplementedSampleServiceServer) Echo(context.Context, *StringMessage) (*StringMessage, error) {
...
func _SampleService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SampleServiceServer).Echo(ctx, req.(*StringMessage))
	}
...
var SampleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.sample.v1.SampleService",
